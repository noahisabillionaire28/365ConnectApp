/**
 * Step 6 of 7 — Pay Rate + Description & Requirements
 */
    ...
    <div className="min-h-[100dvh] bg-[#F7F8FA] flex flex-col pb-[72px]">
      ...
      <div className="bg-white px-5 pt-5 pb-4 border-b border-[#E5E7EB] sticky top-0 z-30">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div className="flex-1"><StepBar current={6} total={7} /></div>
          <span className="text-[#6B7280] text-[12px] font-semibold flex-shrink-0">6 of 7</span>
        </div>
