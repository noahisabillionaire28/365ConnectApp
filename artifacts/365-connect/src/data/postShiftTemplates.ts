...
/* ─── Mock matched workers for the swipe step ─────────────────────────────── */
...
export const MOCK_MATCHED_WORKERS: MatchedWorker[] = [
  {
    id: 'mw1',
    name: 'Marcus Brown',
    username: 'marcus_b',
    ...
    rating: 4.9,
    matchPct: 97,
    skills: ['Craft Cocktails', 'TIPS Certified', 'High-Volume'],
    shiftsCompleted: 47,
  },
  {
    id: 'mw2',
    ...
    rating: 4.7,
    matchPct: 94,
    skills: ['Fine Dining', 'Wine Service', 'Bilingual'],
    shiftsCompleted: 62,
  },
  {
    id: 'mw3',
    ...
    rating: 4.8,
    matchPct: 91,
    skills: ['G License', 'Crowd Control', 'De-escalation'],
    shiftsCompleted: 89,
  },
  {
    id: 'mw4',
    ...
    rating: 4.6,
    matchPct: 88,
    skills: ['Social Media', 'Bilingual', 'Brand Experience'],
    shiftsCompleted: 33,
  },
  {
    id: 'mw5',
    ...
    rating: 4.9,
    matchPct: 96,
    skills: ['Event Setup', 'Rigging', 'AV Equipment'],
    shiftsCompleted: 54,
  },
  {
    id: 'mw6',
    name: 'Alex Parker',
    username: 'alex_p',
    photoUrl: 'https://i.pravatar.cc/600?img=8',
    rating: 4.5,
    matchPct: 85,
    skills: ['Catering', 'Silver Service', 'UHNW Experience'],
    shiftsCompleted: 28,
  },
  {
    id: 'mw7',
    name: 'Maya Johnson',
    username: 'maya_j',
    photoUrl: 'https://i.pravatar.cc/600?img=56',
    rating: 4.8,
    matchPct: 93,
    skills: ['SevenRooms', 'Fine Dining Host', 'VIP Service'],
    shiftsCompleted: 71,
  },
  {
    id: 'mw8',
    name: 'Derek Liu',
    username: 'derek_l',
    photoUrl: 'https://i.pravatar.cc/600?img=3',
    rating: 4.7,
    matchPct: 90,
    skills: ['VIP Server', 'Bottle Service', 'Celebrity Events'],
    shiftsCompleted: 45,
  },
  {
    id: 'mw9',
    name: 'Priya Nair',
    username: 'priya_n',
    photoUrl: 'https://i.pravatar.cc/600?img=49',
    rating: 4.9,
    matchPct: 95,
    skills: ['Corporate Events', 'Multilingual', 'Fine Dining'],
    shiftsCompleted: 38,
  },
  {
    id: 'mw10',
    ...
    rating: 4.6,
    matchPct: 82,
    skills: ['Bar Back', 'Bar Setup', 'Fast Learner'],
    shiftsCompleted: 19,
  },
];
